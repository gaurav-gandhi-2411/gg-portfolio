...
export function HeatToyShell() {
  ...
  return (
    ...
    <button
      ...
      className="font-heading -my-2 flex min-h-11 w-fit items-center gap-2 text-left text-lg text-foreground italic underline decoration-border decoration-1 underline-offset-4 transition-colors hover:decoration-accent focus-visible:decoration-accent motion-reduce:transition-none"
    >
