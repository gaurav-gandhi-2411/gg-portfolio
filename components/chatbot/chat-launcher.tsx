...
export function ChatLauncher() {
  ...
  return (
    ...
    >
      <Link
        href="/ask"
        className="border-border/60 bg-card/90 text-foreground hover:border-accent/60 hover:bg-card focus-visible:outline-ring flex min-h-11 items-center gap-2 rounded-full border px-4 py-2.5 text-sm font-medium backdrop-blur-md transition-[transform,box-shadow,border-color,background-color] duration-200 ease-out hover:-translate-y-0.5 hover:shadow-card-hover focus-visible:outline-2 focus-visible:outline-offset-2 motion-reduce:transition-none motion-reduce:hover:translate-y-0"
      >
        <svg
          width="16"
          height="16"
